...
const PLAYER_HAS_VALUE_X: TicTacToePlayer = { id: '1', value: TicTacToeCellValuesEnum.X, isTurnToStartGame: true }
const PLAYER_HAS_VALUE_Y: TicTacToePlayer = { id: '2', value: TicTacToeCellValuesEnum.O, isTurnToStartGame: false }
